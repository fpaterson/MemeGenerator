...
function showJoke() {
  ...
  //esto le asigna al elemento un texto de un chiste al azar, que creó más arriba
...
function showQuote() {
  ...
  //establece el contenido de la cita en la propiedad textContent de quote
  quote.textContent = randomQuote.quote;

  //establece el autor de la cita en la propiedad author de quote
  author.textContent = "- " + randomQuote.author;

  clearAll();

  //ponen el html con la cita creado arriba como hijo en el elemento elegido (quote-content)
...
function revealAnswers() {
  // primero agarramos al contenedor del acertijo
  const riddleContainer = document.querySelector('.riddle-content');
// luego nos fijamos si tiene un <p> dentro
  const riddle = riddleContainer.querySelector('p');

  //tengo que tomar al elemento answer porque no es global 
  ...
  if (riddle && answer.hidden){
    ...
    alert("Ya hay una respuesta");
  } else{
    alert("No hay acertijo del que obtener una respuesta")
  }
